      ...
      <div className="relative max-w-7xl mx-auto px-5 md:px-6 lg:px-12 flex flex-col lg:flex-row items-center lg:items-start gap-16 lg:gap-8">
        ...
        <div className="w-full lg:w-1/2 flex flex-col mt-24 lg:mt-16 relative z-20 lg:pl-12">
          ...
          <div className="mb-8">
            ...
            <h2 className="font-[family-name:var(--font-cormorant)] text-5xl md:text-7xl text-adia-violet-dark tracking-wide leading-tight">
              L&apos;Éclat <br />
              <span className="font-[family-name:var(--font-script)] text-adia-gold text-6xl md:text-8xl lowercase">éternel</span>
            </h2>
          </div>
          
          <div className="bg-adia-cream/60 backdrop-blur-sm p-0 md:p-6 text-adia-charcoal">
            <p className="font-[family-name:var(--font-cormorant)] text-lg leading-relaxed first-letter:float-left first-letter:text-7xl first-letter:pr-4 first-letter:font-[family-name:var(--font-display)] first-letter:text-adia-violet-dark first-letter:leading-[0.8] mb-6">
